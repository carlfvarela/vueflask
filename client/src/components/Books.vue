    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-10">
          ...
          <b-btn v-b-modal="'book-modal'" class="btn btn-primary">Add book</b-btn>
          <hr><br><br>
        ...
        <b-modal ref="addBookModal" id="book-modal" title="add a new book" hide-footer>
          <b-form @submit="onSubmit" @reset="onReset" class="w-100">
            ...
            <b-form-group id="form-title-group" label="Author:" label-for="form-author-input">
        ...
        <b-modal ref="editBookModal" id="book-update-modal" title="Update" hide-footer>
          <b-form @submit="onSubmitUpdate" @reset="onResetUpdate" class="w-100">
            <b-form-group id="form-title-edit-group" label="Title:" label-for="form-title-edit-input">
              <b-form-input id="form-title-edit-input" type="text" v-model="editFormTemp.title" required></b-form-input>
            </b-form-group>

              <b-form-group id="form-author-edit-group" label="Author:" label-for="form-author-edit-input">
                <b-form-input id="form-author-edit-input" type="text" v-model="editFormTemp.author" required></b-form-input>
            </b-form-group>
...
export default {
  ...
  methods:{
    ...
    editBook(book){
      this.editFormTemp = Object.assign({},book);
    },
